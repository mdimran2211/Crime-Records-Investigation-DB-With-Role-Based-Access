# 🚔 Crime Management System – Insert Data

This file contains sample **SQL INSERT queries** for all tables in the database.  
Each table has **10 records** for testing and demonstration.
